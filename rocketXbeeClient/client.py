...
#However, you can configure the timeout using the get_sync_ops_timeout() and set_sync_ops_timeout() methods of an XBee class.
xbee.open()
...
# This mechanism for reading data does not block your application. 
# Instead, you can be notified when new data has been received if you are subscribed or registered 
# to the data reception service using the add_data_received_callback() method with a data reception callback as parameter.
#
